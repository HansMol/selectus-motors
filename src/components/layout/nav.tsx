    ...
    <header className="sticky top-0 z-50 bg-[rgba(10,10,15,0.88)] backdrop-blur-[12px] border-b border-[rgba(255,255,255,0.05)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/search?sellerType=private" className="text-sm font-medium text-[#6E6E73] hover:text-white transition-colors">
              Private Sales
            </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              href="/login"
              className="text-sm font-medium text-[#6E6E73] hover:text-white transition-colors"
            >
              Sign in
            </Link>
            <Link
      ...
      {open && (
        <div className="md:hidden border-t border-[rgba(255,255,255,0.05)] bg-[#0A0A0F] px-4 py-4 space-y-3">
          ...
          <Link href="/search?sellerType=private" className="block text-sm font-medium text-[#6E6E73] hover:text-white py-2 transition-colors">Private Sales</Link>
          ...
          <div className="pt-2 border-t border-[#1C1C1E] flex gap-3">
            <Link href="/login" className="flex-1 text-center text-sm font-medium border border-[#1C1C1E] rounded-md py-2 text-[#6E6E73] hover:text-white hover:border-[#C4C6CC] transition-colors">Sign in</Link>
