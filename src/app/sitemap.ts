...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: 'https://kerb.autos/guides', lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
    { url: 'https://kerb.autos/guides/how-to-buy-a-used-car-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
